...
public class DialogContent extends ParentPage {
    ...
    @FindBy (xpath = "//span[text()=' Balistreri ']")
    public WebElement balistreri;

    @FindBy (xpath = "//span[text()=' Duncan ']")
    public WebElement duncan;

    @FindBy (xpath = "//span[text()=' Brittany ']")
    public WebElement brittany;

    @FindBy (xpath = "//span[text()=' Breitenberg ']")
    public WebElement breitenberg;
    ...
    public WebElement getWebElement(String strElement) {
        ...
        switch (strElement) {
            ...
            case "balistreri" :
                return this.balistreri;
            case "duncan" :
                return this.duncan;
            case "brittany" :
                return this.brittany;
            case "breitenberg" :
                return this.breitenberg;
