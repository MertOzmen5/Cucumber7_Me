...
public class _15_JDBCSteps {
    ...
    public void sendTheQueryTheDatabaseAndControlMatch(String statesList) {
        ...
        List<List<String>> dbList=DBUtility.getListData(statesList);

        // DB den okuyabildim mi kontrol ediyorum
        for (int i = 0; i <dbList.size() ; i++)
            System.out.println(dbList.get(i).get(0)); // satırların ilk elemanları yani şehirler
